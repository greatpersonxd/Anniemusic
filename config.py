...
BOT_NAME = getenv("BOT_NAME", "˹zօվմ ✘ ตմsíc ")
ASSUSERNAME = getenv("ASSUSERNAME", "ZOYUASSISTANT1")
...
OWNER_ID = int(getenv("OWNER_ID", 6544310700)

# Heroku deployment settings - Refer to Heroku documentation on how to obtain these
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/greatpersonxd/Anniemusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/The_Incricible")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Incriciblei")
